...
// CAMBIOS:
//  1. Turistas agregado a _pages y _navItems (solo admin_general)
//  2. rewardsIndex: 3→4, reportsIndex: 4→5 para admin_general
//  3. _userId cargado en _init() desde AppConstants.keyUserId
//  4. Mi Perfil → navega a ProfilePage (real)
//  5. Cambiar Contraseña → abre ChangePasswordDialog (real)
//  6. Importados ProfilePage y ChangePasswordDialog
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  String _userEmail         = '';
  String _userRole          = '';
  int?   _userId;              // ← NUEVO: necesario para ChangePasswordDialog
  bool   _loaded            = false;
  ...
  Future<void> _init() async {
    ...
    // ← NUEVO: cargar userId para ChangePasswordDialog
  ...
  // Con Turistas: 0=Inicio 1=Lugares 2=Admins 3=Turistas 4=Recompensas 5=Reportes
  // Sin Turistas: 0=Inicio 1=Lugares 2=Recompensas 3=Reportes
  ...
  List<Widget> get _pages => [
    ...
    if (_showAdmins)
      AdminsListTab(canEdit: _canEdit),
    // ← NUEVO: Turistas — solo admin_general
    if (_showAdmins)
      const UsersPage(),
    const RewardsPage(),
    const ReportsPage(),
                  ...
                  child: InkWell(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                          color: sel ? Colors.teal.withOpacity(0.12) : null,
                      ...
                      child: Row(
                          ...
                          children: [
                            Icon(item.icon,
                                color: sel ? Colors.teal : Colors.grey[600],
                                size: 22),
                            if (_sidebarExpanded) ...[
                ...
                Expanded(child: Column(
                    ...
                    children: [
                      Text(_userName,
                          ...
                          overflow: TextOverflow.ellipsis),
                      Text(AppConstants.getRoleLabel(_userRole),
  ...
  Widget _userMenu() {
    return PopupMenuButton<String>(
      ...
      itemBuilder: (_) => [
        ...
        const PopupMenuItem(value: 'change_password',
            child: ListTile(
      ...
      onSelected: (v) {
        switch (v) {
        // ← NUEVO: Mi Perfil abre ProfilePage real
          case 'profile':
            Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => const ProfilePage()));
            break;

        // ← NUEVO: Cambiar Contraseña abre ChangePasswordDialog real
